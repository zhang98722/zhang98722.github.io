	...
	<body>
		...
		<script type="text/javascript">
			...
			function loadKM(page){
				var url="https://zkillboard.com/api/kills/allianceID/1354830081/startTime/201702241100/endTime/201702271100/no-items/no-attackers/page/"+page+"/";
				$.ajax({  
				   type: "GET",  
				   url: url,  
				   dataType: "json",  
				   success: function (data) {
						...
						$("#totalIsk").html(parseFloat((parseFloat($("#totalIskHidden").val())/1000000000)).toFixed(2)+" B");
							return null;
						}else{
